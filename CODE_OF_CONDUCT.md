...
When an incident does occur, report it privately through the repository's
[GitHub Security Advisory form](https://github.com/KickNext/flutter_webmcp/security/advisories/new)
and begin the report title with `Code of Conduct`. Do not include sensitive
...
in private with the involved parties, but communicating to the whole community
...
2. **Temporarily Limited Activities**
   ...
   - Repair: Examples include making an apology, reflecting during the cooldown,
     and being thoughtful about re-entering community spaces.
3. **Temporary Suspension**
   - Event: A pattern of repeated violations which moderators have tried to
   ...
   - Repair: Examples include respecting the suspension, meeting the conditions
     for return, and reintegrating thoughtfully.
4. **Permanent Ban**
   - Event: A repeated pattern that other steps failed to resolve, or a violation
     so serious that the community cannot be kept safe otherwise.
...
ability of Community Managers to use their discretion and judgment in the best
